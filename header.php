...
<body <?php body_class(); ?>>
    ...
    <header>
        <div id="sm-nav">
            ...
            <div>
                Summer sale discount off <b style="color: red;">50%!</b> <a href="<?php echo home_url('/'); ?>">Shop
                    Now</a>
            </div>
        ...
        <div class="container-woo">
            <div class="logo">
                <a href="<?= home_url('/') ?>">
                    <svg width="150" height="35" viewBox="0 0 113 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="svgs">
                <ul>
                    <li class="search">
                        <svg width="21" height="21" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
                            clip-rule="evenodd">
                            <path
                    ...
                    <li class="cart">
                        <a class="modex" href="<?php echo wc_get_cart_url(); ?>">
